            ...
            {isOpen && (
                <div className="fixed top-0 left-0 w-64 h-80 bg-black text-white p-5 transform transition-transform duration-700 ease-in-out">
                    ...
                    <ul className='mt-10'>
                        ...
                        <li className="p-2 hover:bg-gray-700">
                            <Link href='/blog' className="hover:bg-gray-700" onClick={handleLinkClick}>Blog</Link>
                        </li>
                    </ul>


                     <div className='flex space-x-4 mt-7'>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className='w-6 h-6 cursor-pointer'>
                            <path d="M2.5 3A1.5 1.5 0 0 0 1 4.5v.793c.026.009.051.02.076.032L7.674 8.51c.206.1.446.1.652 0l6.598-3.185A.755.755 0 0 1 15 5.293V4.5A1.5 1.5 0 0 0 13.5 3h-11Z" />
                            <path d="M15 6.954 8.978 9.86a2.25 2.25 0 0 1-1.956 0L1 6.954V11.5A1.5 1.5 0 0 0 2.5 13h11a1.5 1.5 0 0 0 1.5-1.5V6.954Z" />
                        </svg>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='fill-current w-6 h-6 cursor-pointer'>
                        ...
                        <a href="https://github.com/spencerattick">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className='fill-current w-6 h-6 cursor-pointer'>
                        ...
                        <a href="https://medium.com/@spencer.attick" target='_blank'> 
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className='fill-current w-6 h-6 cursor-pointer'>
                        ...
                        <a href="https://www.linkedin.com/in/ryan-spencer-attick/" target="_blank">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className='fill-current w-6 h-6 cursor-pointer'>
