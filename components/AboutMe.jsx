    ...
    return (
        <div className="flex justify-center items-center h-full m-20">
          <div className="flex-col justify-center items-center h-full p-3 md:p-5 lg:p-20">
            ...
            <a href="https://github.com/spencerattick" target="_blank" className="flex items-center justify-center mt-10 lg:mt-20 border-2 border-red-500 p-2 w-2/5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-7 h-7 cursor-pointer hidden pr-2 lg:block">
