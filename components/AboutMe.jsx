    ...
    return (
        <div className="flex justify-center items-center h-full m-20">
          <div className="flex-col justify-center items-center h-full p-3 md:p-5 lg:p-20">
            ...
            <a href="https://github.com/spencerattick" target="_blank" className="flex items-center justify-center mt-10 lg:mt-20 border-2 border-red-500 p-2 lg:w-2/5 w-4/5">
