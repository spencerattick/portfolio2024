      ...
      <div>
        {githubCommitData ? (
          ...
          <div className="flex-col justify-center items-center h-full p-3 md:p-5 lg:p-20">
            ...
            {githubCommitData && (<a href="https://github.com/spencerattick" target="_blank" className="flex items-center justify-center mt-10 lg:mt-20 border-2 border-red-500 p-2 lg:w-2/5 w-4/5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" className="w-7 h-7 cursor-pointer pr-2">
              ...
              <p className="font-medium text-center text-sm xl:pl-4 pl-0 lg:text-lg">
                GitHub commits this year: <span className="font-semibold text-red-500">{githubCommitData}</span> 
              </p>
            </a>)
           }
          </div>
