            ...
            <div className="flex flex-col justify-center items-center h-screen md:h-full lg:ml-5">
                ...
                <ul className="flex flex-wrap justify-around">
                    {projects.map((project, index) => {
                        ...
                        return (
                            <li key={index} className="text-xl m-10 mx-12 shadow-lg shadow-gray-500 hover:text-white ease-in-out duration-200 h-60 w-60 md:h-80 md:w-80 border-0 border-b-red-500 border-b-8 hover:bg-black hover:w-96 rounded-lg">
                                <a href={project.guid} target="_blank" className="cursor-pointer">
                                    <div className="text-center flex flex-col justify-center items-center">
                                        ...
                                        <div className="relative w-full h-10 md:h-44">
